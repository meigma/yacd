...
func (_mock *Resolver) Resolve(ctx context.Context) (string, error) {
...
//   - ctx context.Context
func (_e *Resolver_Expecter) Resolve(ctx interface{}) *Resolver_Resolve_Call {
	return &Resolver_Resolve_Call{Call: _e.mock.On("Resolve", ctx)}
}

func (_c *Resolver_Resolve_Call) Run(run func(ctx context.Context)) *Resolver_Resolve_Call {
...
func (_c *Resolver_Resolve_Call) Return(path string, err error) *Resolver_Resolve_Call {
	_c.Call.Return(path, err)
	return _c
}

func (_c *Resolver_Resolve_Call) RunAndReturn(run func(ctx context.Context) (string, error)) *Resolver_Resolve_Call {
	_c.Call.Return(run)
	return _c
}
