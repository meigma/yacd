...
* **cardanonetwork:** remove the network-artifacts ConfigMap and custom-public; read node config from the PVC (F0 PR-B1) ([#78](https://github.com/meigma/yacd/issues/78))
...
* **cardanonetwork:** pin the cardano-tools image to a published digest (F0 PR-D) ([#82](https://github.com/meigma/yacd/issues/82)) ([bd8e0bf](https://github.com/meigma/yacd/commit/bd8e0bf1de01f5b0e7b3d939dc16acdb9882c1ce))
...
* **cardanonetwork:** remove the network-artifacts ConfigMap and custom-public; read node config from the PVC (F0 PR-B1) ([#78](https://github.com/meigma/yacd/issues/78)) ([606d800](https://github.com/meigma/yacd/commit/606d8001dbce33084ccc192f58b4f71402f04b51))
...
* **release:** target the first operator release at v0.1.0 ([#83](https://github.com/meigma/yacd/issues/83)) ([925caec](https://github.com/meigma/yacd/commit/925caec3635ceda98305d267a8edae32a66c6b60))
