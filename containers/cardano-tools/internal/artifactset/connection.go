...
// connectionNetwork is the network-identity sub-object of connection.json.
...
// connectionEndpoint is the primary node-to-node endpoint sub-object of
// connection.json.
...
// renderConnection serializes the connection.json document for input using
// fileKeys as the connection-key-to-ConfigMap-data-key mapping. The returned
// string is JSON with two-space indentation and a trailing newline.
